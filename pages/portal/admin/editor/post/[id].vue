...
<template>
  <UDashboardPage>
    <UDashboardPanel>
      <UDashboardNavbar
        :title="isNew ? 'Create New Spotlight' : 'Edit Spotlight'"
      >
        <template #right>
          <div class="flex items-center gap-2">
            ...
            />
            <UButton
              v-if="spotlight.status === 'draft'"
              icon="i-heroicons-paper-airplane"
              label="Publish"
              color="success"
              @click="publishSpotlight"
            />
            <UButton
              icon="i-heroicons-document-check"
              label="Save"
              color="primary"
              @click="updateSpotlight"
            />
          </div>
        </template>
      </UDashboardNavbar>
                ...
                <UCard>
                  ...
                  <div>
                    ...
                    <p class="text-xs text-gray-500">
                      This image will be displayed at the top of the post and in
                      post lists.
                    </p>
                  </div>
                </UCard>
              ...
              <UCard>
                ...
                <div class="min-h-[400px]">
                  ...
                  >
                    ...
                    >
                      <div
                        class="aspect-square relative overflow-hidden bg-gray-100"
                      >
                        <NuxtImg
