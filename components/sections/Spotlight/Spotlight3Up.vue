  ...
  <div class='bg-gray-900 py-24 sm:py-32'>
    <div class='mx-auto max-w-7xl px-6 lg:px-8'>
      <div class='mx-auto max-w-2xl text-center'>
        <h2 class='text-3xl font-bold tracking-tight sm:text-4xl capitalize'>From the spotlights</h2>
        <p class='mt-2 text-lg leading-8 text-gray-300'>Featuring the brightest minds and businesses in our network.</p>
      </div>
      <div
            ...
            <div class='max-w-xl'>
              ...
              <div class='relative mt-8 flex items-center gap-x-4'>
                <NuxtImg
                  ...
                  :src='$urlFor(spotlight.author[0].image).width(50).height(50).url()'
                  alt=''
                />
