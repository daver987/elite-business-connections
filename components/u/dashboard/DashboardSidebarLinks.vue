...
function onDrop(results: {
  ...
  const itemToAdd =
    removedIndex !== null ? links.splice(removedIndex, 1)[0] : payload

  if (addedIndex !== null) {
    links.splice(addedIndex, 0, itemToAdd as DashboardSidebarLink)
  }
          ...
          >
            ...
            >
              ...
              <slot :link="link" :is-active="isActive">
                ...
                >
                  <span class="sr-only" v-if="isActive"> Current page: </span>
